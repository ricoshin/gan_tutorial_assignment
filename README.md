...
실습 일시: 2019년 7월 24일(수), 14:00 - 17:00
담당조교:신우현 (rico.shin@gmail.com), 이하연 (hayeon926@kaist.ac.kr)

## 개요
A. 전반부에 진행했던 내용(신우현 조교)은 Quiz 문제에 대한 답을 제출 
B. 후반부에 진행했던 내용(이하연 조교)은 제공된 코드를 기반으로 실행 결과 제출
...
![fig1](https://drive.google.com/uc?id=1okeBGAk-gzAdJJzV4HJjBqQk9GirLe6f)
